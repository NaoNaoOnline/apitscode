...
// @generated from protobuf file "pbf/list/delete.proto" (package "list", syntax proto3)
// tslint:disable
 ...
 *
 *
 * @generated from protobuf message list.DeleteI
 */
export interface DeleteI {
  /**
   * @generated from protobuf field: list.DeleteI_Filter filter = 100;
   */
  filter?: DeleteI_Filter;
  /**
   * @generated from protobuf field: repeated list.DeleteI_Object object = 200;
   */
  object: DeleteI_Object[];
}
/**
 * @generated from protobuf message list.DeleteI_Filter
 */
export interface DeleteI_Filter {}
/**
 * @generated from protobuf message list.DeleteI_Object
 */
export interface DeleteI_Object {
  /**
   * @generated from protobuf field: list.DeleteI_Object_Intern intern = 100;
   */
  intern?: DeleteI_Object_Intern;
  /**
   * @generated from protobuf field: list.DeleteI_Object_Public public = 200;
   */
  public?: DeleteI_Object_Public;
}
/**
 * @generated from protobuf message list.DeleteI_Object_Intern
 */
...
/**
 * @generated from protobuf message list.DeleteI_Object_Public
 */
 ...
 *
 *
 * @generated from protobuf message list.DeleteO
 */
export interface DeleteO {
  /**
   * @generated from protobuf field: list.DeleteO_Filter filter = 100;
   */
  filter?: DeleteO_Filter;
  /**
   * @generated from protobuf field: repeated list.DeleteO_Object object = 200;
   */
  object: DeleteO_Object[];
}
/**
 * @generated from protobuf message list.DeleteO_Filter
 */
export interface DeleteO_Filter {}
/**
 * @generated from protobuf message list.DeleteO_Object
 */
export interface DeleteO_Object {
  /**
   * @generated from protobuf field: list.DeleteO_Object_Intern intern = 100;
   */
  intern?: DeleteO_Object_Intern;
  /**
   * @generated from protobuf field: list.DeleteO_Object_Public public = 200;
   */
  public?: DeleteO_Object_Public;
}
/**
 * @generated from protobuf message list.DeleteO_Object_Intern
 */
...
/**
 * @generated from protobuf message list.DeleteO_Object_Public
 */
...
/**
 * @generated MessageType for protobuf message list.DeleteI
 */
...
/**
 * @generated MessageType for protobuf message list.DeleteI_Filter
 */
...
/**
 * @generated MessageType for protobuf message list.DeleteI_Object
 */
...
/**
 * @generated MessageType for protobuf message list.DeleteI_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message list.DeleteI_Object_Public
 */
...
/**
 * @generated MessageType for protobuf message list.DeleteO
 */
...
/**
 * @generated MessageType for protobuf message list.DeleteO_Filter
 */
...
/**
 * @generated MessageType for protobuf message list.DeleteO_Object
 */
...
/**
 * @generated MessageType for protobuf message list.DeleteO_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message list.DeleteO_Object_Public
 */
