...
// @generated from protobuf file "pbf/list/update.proto" (package "list", syntax proto3)
// tslint:disable
 ...
 *
 *
 * @generated from protobuf message list.UpdateI
 */
export interface UpdateI {
  /**
   * @generated from protobuf field: list.UpdateI_Filter filter = 100;
   */
  filter?: UpdateI_Filter;
  /**
   * @generated from protobuf field: repeated list.UpdateI_Object object = 200;
   */
  object: UpdateI_Object[];
}
/**
 * @generated from protobuf message list.UpdateI_Filter
 */
export interface UpdateI_Filter {}
/**
 * @generated from protobuf message list.UpdateI_Object
 */
export interface UpdateI_Object {
  /**
   * @generated from protobuf field: list.UpdateI_Object_Intern intern = 100;
   */
  intern?: UpdateI_Object_Intern;
  /**
   * @generated from protobuf field: list.UpdateI_Object_Public public = 200;
   */
  public?: UpdateI_Object_Public;
  /**
   * @generated from protobuf field: list.UpdateI_Object_Symbol symbol = 300;
   */
  symbol?: UpdateI_Object_Symbol;
  /**
   * @generated from protobuf field: repeated list.UpdateI_Object_Update update = 400;
   */
  update: UpdateI_Object_Update[];
}
/**
 * @generated from protobuf message list.UpdateI_Object_Intern
 */
...
/**
 * @generated from protobuf message list.UpdateI_Object_Public
 */
export interface UpdateI_Object_Public {}
/**
 * @generated from protobuf message list.UpdateI_Object_Symbol
 */
export interface UpdateI_Object_Symbol {}
/**
 * @generated from protobuf message list.UpdateI_Object_Update
 */
 ...
 *
 *
 * @generated from protobuf message list.UpdateO
 */
export interface UpdateO {
  /**
   * @generated from protobuf field: list.UpdateO_Filter filter = 100;
   */
  filter?: UpdateO_Filter;
  /**
   * @generated from protobuf field: repeated list.UpdateO_Object object = 200;
   */
  object: UpdateO_Object[];
}
/**
 * @generated from protobuf message list.UpdateO_Filter
 */
export interface UpdateO_Filter {}
/**
 * @generated from protobuf message list.UpdateO_Object
 */
export interface UpdateO_Object {
  /**
   * @generated from protobuf field: list.UpdateO_Object_Intern intern = 100;
   */
  intern?: UpdateO_Object_Intern;
  /**
   * @generated from protobuf field: list.UpdateO_Object_Public public = 200;
   */
  public?: UpdateO_Object_Public;
}
/**
 * @generated from protobuf message list.UpdateO_Object_Intern
 */
...
/**
 * @generated from protobuf message list.UpdateO_Object_Public
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateI
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateI_Filter
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateI_Object
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateI_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateI_Object_Public
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateI_Object_Symbol
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateI_Object_Update
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateO
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateO_Filter
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateO_Object
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateO_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message list.UpdateO_Object_Public
 */
