...
export interface UpdateI {
  /**
   * @generated from protobuf field: description.UpdateI_Filter filter = 100;
   */
  filter?: UpdateI_Filter;
  /**
   * @generated from protobuf field: repeated description.UpdateI_Object object = 200;
   */
...
export interface UpdateI_Object {
  /**
   * @generated from protobuf field: description.UpdateI_Object_Intern intern = 100;
   */
  intern?: UpdateI_Object_Intern;
  /**
   * @generated from protobuf field: description.UpdateI_Object_Public public = 200;
   */
  public?: UpdateI_Object_Public;
  /**
   * @generated from protobuf field: description.UpdateI_Object_Symbol symbol = 300;
   */
  symbol?: UpdateI_Object_Symbol;
  /**
   * @generated from protobuf field: repeated description.UpdateI_Object_Update update = 400;
   */
  update: UpdateI_Object_Update[];
}
/**
 * @generated from protobuf message description.UpdateI_Object_Intern
 */
...
/**
 * @generated from protobuf message description.UpdateI_Object_Public
 */
...
export interface UpdateO {
  /**
   * @generated from protobuf field: description.UpdateO_Filter filter = 100;
   */
  filter?: UpdateO_Filter;
  /**
   * @generated from protobuf field: repeated description.UpdateO_Object object = 200;
   */
...
export interface UpdateO_Object {
  /**
   * @generated from protobuf field: description.UpdateO_Object_Intern intern = 100;
   */
  intern?: UpdateO_Object_Intern;
  /**
   * @generated from protobuf field: description.UpdateO_Object_Public public = 200;
   */
  public?: UpdateO_Object_Public;
}
/**
 * @generated from protobuf message description.UpdateO_Object_Intern
 */
