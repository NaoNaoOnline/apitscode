 ...
 *
 *
 * @generated from protobuf message description.UpdateI
 */
export interface UpdateI {
  /**
   * @generated from protobuf field: description.UpdateI_Filter filter = 1;
   */
  filter?: UpdateI_Filter;
  /**
   * @generated from protobuf field: repeated description.UpdateI_Object object = 2;
   */
  object: UpdateI_Object[];
}
/**
 * @generated from protobuf message description.UpdateI_Filter
 */
export interface UpdateI_Filter {}
/**
 * @generated from protobuf message description.UpdateI_Object
 */
export interface UpdateI_Object {
  ...
  /**
   * @generated from protobuf field: repeated description.UpdateI_Object_Update update = 2;
   */
 ...
 *
 *
 * @generated from protobuf message description.UpdateO
 */
export interface UpdateO {
  /**
   * @generated from protobuf field: description.UpdateO_Filter filter = 1;
   */
  filter?: UpdateO_Filter;
  /**
   * @generated from protobuf field: repeated description.UpdateO_Object object = 2;
   */
  object: UpdateO_Object[];
}
/**
 * @generated from protobuf message description.UpdateO_Filter
 */
export interface UpdateO_Filter {}
/**
 * @generated from protobuf message description.UpdateO_Object
 */
export interface UpdateO_Object {
  ...
  /**
   * @generated from protobuf field: description.UpdateO_Object_Public public = 2;
   */
  public?: UpdateO_Object_Public;
}
/**
 * @generated from protobuf message description.UpdateO_Object_Public
 */
  ...
  private binaryReadMap1(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field description.UpdateI_Object.intern",
          );
      }
    }
    map[key ?? ""] = val ?? "";
  ...
  private binaryReadMap1(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field description.UpdateO_Object.intern",
          );
      }
    }
    map[key ?? ""] = val ?? "";
