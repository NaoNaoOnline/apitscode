...
export interface DeleteI {
  /**
   * @generated from protobuf field: description.DeleteI_Filter filter = 100;
   */
  filter?: DeleteI_Filter;
  /**
   * @generated from protobuf field: repeated description.DeleteI_Object object = 200;
   */
...
export interface DeleteI_Object {
  /**
   * @generated from protobuf field: description.DeleteI_Object_Intern intern = 100;
   */
  intern?: DeleteI_Object_Intern;
  /**
   * @generated from protobuf field: description.DeleteI_Object_Public public = 200;
   */
  public?: DeleteI_Object_Public;
}
/**
 * @generated from protobuf message description.DeleteI_Object_Intern
 */
...
export interface DeleteO {
  /**
   * @generated from protobuf field: description.DeleteO_Filter filter = 100;
   */
  filter?: DeleteO_Filter;
  /**
   * @generated from protobuf field: repeated description.DeleteO_Object object = 200;
   */
...
export interface DeleteO_Object {
  /**
   * @generated from protobuf field: description.DeleteO_Object_Intern intern = 100;
   */
  intern?: DeleteO_Object_Intern;
  /**
   * @generated from protobuf field: description.DeleteO_Object_Public public = 200;
   */
  public?: DeleteO_Object_Public;
}
/**
 * @generated from protobuf message description.DeleteO_Object_Intern
 */
