        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field description.SearchI_Object.intern");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field description.SearchO_Object.intern");
            }
        }
        map[key ?? ""] = val ?? "";
    }
