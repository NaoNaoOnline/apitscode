...
class DeleteI$Type extends MessageType {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* subscription.DeleteI_Filter filter */ 100:
                    message.filter = DeleteI_Filter.internalBinaryRead(reader, reader.uint32(), options, message.filter);
                    break;
                case /* repeated subscription.DeleteI_Object object */ 200:
...
class DeleteI_Filter$Type extends MessageType {
    constructor() {
        super("subscription.DeleteI_Filter", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class DeleteI_Object$Type extends MessageType {
    constructor() {
        super("subscription.DeleteI_Object", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* subscription.DeleteI_Object_Intern intern */ 100:
                    message.intern = DeleteI_Object_Intern.internalBinaryRead(reader, reader.uint32(), options, message.intern);
                    break;
                case /* subscription.DeleteI_Object_Public public */ 200:
...
class DeleteI_Object_Intern$Type extends MessageType {
    constructor() {
        super("subscription.DeleteI_Object_Intern", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class DeleteI_Object_Public$Type extends MessageType {
    constructor() {
        super("subscription.DeleteI_Object_Public", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class DeleteO$Type extends MessageType {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* subscription.DeleteO_Filter filter */ 100:
                    message.filter = DeleteO_Filter.internalBinaryRead(reader, reader.uint32(), options, message.filter);
                    break;
                case /* repeated subscription.DeleteO_Object object */ 200:
...
class DeleteO_Filter$Type extends MessageType {
    constructor() {
        super("subscription.DeleteO_Filter", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class DeleteO_Object$Type extends MessageType {
    constructor() {
        super("subscription.DeleteO_Object", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* subscription.DeleteO_Object_Intern intern */ 100:
                    message.intern = DeleteO_Object_Intern.internalBinaryRead(reader, reader.uint32(), options, message.intern);
                    break;
                case /* subscription.DeleteO_Object_Public public */ 200:
...
class DeleteO_Object_Intern$Type extends MessageType {
    constructor() {
        super("subscription.DeleteO_Object_Intern", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class DeleteO_Object_Public$Type extends MessageType {
    constructor() {
        super("subscription.DeleteO_Object_Public", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
