 ...
 *
 *
 * @generated from protobuf message rating.SearchI
 */
export interface SearchI {
  /**
   * @generated from protobuf field: rating.SearchI_Filter filter = 100;
   */
  filter?: SearchI_Filter;
  /**
   * @generated from protobuf field: repeated rating.SearchI_Object object = 200;
   */
  object: SearchI_Object[];
}
/**
 * @generated from protobuf message rating.SearchI_Filter
 */
export interface SearchI_Filter {
  /**
   * @generated from protobuf field: rating.SearchI_Filter_Chunking chunking = 100;
   */
  chunking?: SearchI_Filter_Chunking;
}
/**
 * @generated from protobuf message rating.SearchI_Filter_Chunking
 */
...
/**
 * @generated from protobuf message rating.SearchI_Object
 */
export interface SearchI_Object {
  /**
   * @generated from protobuf field: rating.SearchI_Object_Intern intern = 100;
   */
  intern?: SearchI_Object_Intern;
  /**
   * @generated from protobuf field: rating.SearchI_Object_Public public = 200;
   */
  public?: SearchI_Object_Public;
}
/**
 * @generated from protobuf message rating.SearchI_Object_Intern
 */
export interface SearchI_Object_Intern {}
/**
 * @generated from protobuf message rating.SearchI_Object_Public
 */
 ...
 *
 *
 * @generated from protobuf message rating.SearchO
 */
export interface SearchO {
  /**
   * @generated from protobuf field: rating.SearchO_Filter filter = 100;
   */
  filter?: SearchO_Filter;
  /**
   * @generated from protobuf field: repeated rating.SearchO_Object object = 200;
   */
  object: SearchO_Object[];
}
/**
 * @generated from protobuf message rating.SearchO_Filter
 */
export interface SearchO_Filter {}
/**
 * @generated from protobuf message rating.SearchO_Object
 */
export interface SearchO_Object {
  /**
   * @generated from protobuf field: rating.SearchO_Object_Intern intern = 100;
   */
  intern?: SearchO_Object_Intern;
  /**
   * @generated from protobuf field: rating.SearchO_Object_Public public = 200;
   */
  public?: SearchO_Object_Public;
}
/**
 * @generated from protobuf message rating.SearchO_Object_Intern
 */
export interface SearchO_Object_Intern {
   ...
   *
   * @generated from protobuf field: string rtng = 200;
   */
  rtng: string;
  /**
...
/**
 * @generated from protobuf message rating.SearchO_Object_Public
 */
