...
// @generated from protobuf file "pbf/rule/delete.proto" (package "rule", syntax proto3)
// tslint:disable
 ...
 *
 *
 * @generated from protobuf message rule.DeleteI
 */
export interface DeleteI {
  /**
   * @generated from protobuf field: rule.DeleteI_Filter filter = 100;
   */
  filter?: DeleteI_Filter;
  /**
   * @generated from protobuf field: repeated rule.DeleteI_Object object = 200;
   */
  object: DeleteI_Object[];
}
/**
 * @generated from protobuf message rule.DeleteI_Filter
 */
export interface DeleteI_Filter {}
/**
 * @generated from protobuf message rule.DeleteI_Object
 */
export interface DeleteI_Object {
  /**
   * @generated from protobuf field: rule.DeleteI_Object_Intern intern = 100;
   */
  intern?: DeleteI_Object_Intern;
  /**
   * @generated from protobuf field: rule.DeleteI_Object_Public public = 200;
   */
  public?: DeleteI_Object_Public;
}
/**
 * @generated from protobuf message rule.DeleteI_Object_Intern
 */
export interface DeleteI_Object_Intern {
  /**
   * rule is the ID of the rule being deleted.
   *
   * @generated from protobuf field: string rule = 100;
   */
  rule: string;
}
/**
 * @generated from protobuf message rule.DeleteI_Object_Public
 */
 ...
 *
 *
 * @generated from protobuf message rule.DeleteO
 */
export interface DeleteO {
  /**
   * @generated from protobuf field: rule.DeleteO_Filter filter = 100;
   */
  filter?: DeleteO_Filter;
  /**
   * @generated from protobuf field: repeated rule.DeleteO_Object object = 200;
   */
  object: DeleteO_Object[];
}
/**
 * @generated from protobuf message rule.DeleteO_Filter
 */
export interface DeleteO_Filter {}
/**
 * @generated from protobuf message rule.DeleteO_Object
 */
export interface DeleteO_Object {
  /**
   * @generated from protobuf field: rule.DeleteO_Object_Intern intern = 100;
   */
  intern?: DeleteO_Object_Intern;
  /**
   * @generated from protobuf field: rule.DeleteO_Object_Public public = 200;
   */
  public?: DeleteO_Object_Public;
}
/**
 * @generated from protobuf message rule.DeleteO_Object_Intern
 */
...
/**
 * @generated from protobuf message rule.DeleteO_Object_Public
 */
...
/**
 * @generated MessageType for protobuf message rule.DeleteI
 */
...
/**
 * @generated MessageType for protobuf message rule.DeleteI_Filter
 */
...
/**
 * @generated MessageType for protobuf message rule.DeleteI_Object
 */
...
/**
 * @generated MessageType for protobuf message rule.DeleteI_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message rule.DeleteI_Object_Public
 */
...
/**
 * @generated MessageType for protobuf message rule.DeleteO
 */
...
/**
 * @generated MessageType for protobuf message rule.DeleteO_Filter
 */
...
/**
 * @generated MessageType for protobuf message rule.DeleteO_Object
 */
...
/**
 * @generated MessageType for protobuf message rule.DeleteO_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message rule.DeleteO_Object_Public
 */
