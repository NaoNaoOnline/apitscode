...
class DeleteI_Object_Intern$Type extends MessageType {
    constructor() {
        super("rule.DeleteI_Object_Intern", [
            { no: 100, name: "rule", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
    ...
    internalBinaryWrite(message, writer, options) {
        /* string rule = 100; */
        if (message.rule !== "")
            writer.tag(100, WireType.LengthDelimited).string(message.rule);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class DeleteI_Object_Public$Type extends MessageType {
    constructor() {
        super("rule.DeleteI_Object_Public", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class DeleteO_Object_Intern$Type extends MessageType {
    constructor() {
        super("rule.DeleteO_Object_Intern", [
...
class DeleteO_Object_Public$Type extends MessageType {
    constructor() {
        super("rule.DeleteO_Object_Public", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
