 ...
 *
 *
 * @generated from protobuf message reaction.UpdateI
 */
export interface UpdateI {
  /**
   * @generated from protobuf field: reaction.UpdateI_Filter filter = 100;
   */
  filter?: UpdateI_Filter;
  /**
   * @generated from protobuf field: repeated reaction.UpdateI_Object object = 200;
   */
  object: UpdateI_Object[];
}
/**
 * @generated from protobuf message reaction.UpdateI_Filter
 */
export interface UpdateI_Filter {}
/**
 * @generated from protobuf message reaction.UpdateI_Object
 */
export interface UpdateI_Object {
  /**
   * @generated from protobuf field: reaction.UpdateI_Object_Intern intern = 100;
   */
  intern?: UpdateI_Object_Intern;
  /**
   * @generated from protobuf field: reaction.UpdateI_Object_Public public = 200;
   */
  public?: UpdateI_Object_Public;
  /**
   * @generated from protobuf field: reaction.UpdateI_Object_Symbol symbol = 300;
   */
  symbol?: UpdateI_Object_Symbol;
  /**
   * @generated from protobuf field: repeated reaction.UpdateI_Object_Update update = 400;
   */
...
/**
 * @generated from protobuf message reaction.UpdateI_Object_Symbol
 */
 ...
 *
 *
 * @generated from protobuf message reaction.UpdateO
 */
export interface UpdateO {
  /**
   * @generated from protobuf field: reaction.UpdateO_Filter filter = 100;
   */
  filter?: UpdateO_Filter;
  /**
   * @generated from protobuf field: repeated reaction.UpdateO_Object object = 200;
   */
  object: UpdateO_Object[];
}
/**
 * @generated from protobuf message reaction.UpdateO_Filter
 */
export interface UpdateO_Filter {}
/**
 * @generated from protobuf message reaction.UpdateO_Object
 */
export interface UpdateO_Object {
  /**
   * @generated from protobuf field: reaction.UpdateO_Object_Intern intern = 100;
   */
  intern?: UpdateO_Object_Intern;
  /**
   * @generated from protobuf field: reaction.UpdateO_Object_Public public = 200;
   */
  public?: UpdateO_Object_Public;
}
/**
 * @generated from protobuf message reaction.UpdateO_Object_Intern
 */
export interface UpdateO_Object_Intern {}
/**
 * @generated from protobuf message reaction.UpdateO_Object_Public
 */
...
/**
 * @generated MessageType for protobuf message reaction.UpdateI_Object_Symbol
 */
