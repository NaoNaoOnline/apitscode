...
class UpdateI_Object$Type extends MessageType {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* reaction.UpdateI_Object_Intern intern */ 100:
                    ...
                    break;
                case /* repeated reaction.UpdateI_Object_Public public */ 200:
                    message.public.push(UpdateI_Object_Public.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated reaction.UpdateI_Object_Update update */ 300:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated reaction.UpdateI_Object_Public public = 200; */
        ...
        /* repeated reaction.UpdateI_Object_Update update = 300; */
...
class UpdateI_Object_Public$Type extends MessageType {
    constructor() {
        super("reaction.UpdateI_Object_Public", []);
    }
    create(value) {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
