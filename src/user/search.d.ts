...
export interface SearchO_Filter {
  /**
   * @generated from protobuf field: user.SearchO_Filter_Paging paging = 100;
   */
  paging?: SearchO_Filter_Paging;
}
/**
 * @generated from protobuf message user.SearchO_Filter_Paging
 */
...
/**
 * @generated MessageType for protobuf message user.SearchO_Filter_Paging
 */
