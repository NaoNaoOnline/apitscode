...
class SearchO_Object_Intern$Type extends MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* string from = 200; */
        if (message.from !== "")
            writer.tag(200, WireType.LengthDelimited).string(message.from);
        /* string hash = 300; */
        if (message.hash !== "")
