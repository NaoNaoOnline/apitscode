 ...
 *
 *
 * @generated from protobuf message policy.DeleteI
 */
export interface DeleteI {
  /**
   * @generated from protobuf field: policy.DeleteI_Filter filter = 100;
   */
  filter?: DeleteI_Filter;
  /**
   * @generated from protobuf field: repeated policy.DeleteI_Object object = 200;
   */
  object: DeleteI_Object[];
}
/**
 * @generated from protobuf message policy.DeleteI_Filter
 */
export interface DeleteI_Filter {}
/**
 * @generated from protobuf message policy.DeleteI_Object
 */
export interface DeleteI_Object {
  /**
   * @generated from protobuf field: policy.DeleteI_Object_Intern intern = 100;
   */
  intern?: DeleteI_Object_Intern;
  /**
   * @generated from protobuf field: policy.DeleteI_Object_Public public = 200;
   */
  public?: DeleteI_Object_Public;
}
/**
 * @generated from protobuf message policy.DeleteI_Object_Intern
 */
export interface DeleteI_Object_Intern {}
/**
 * @generated from protobuf message policy.DeleteI_Object_Public
 */
 ...
 *
 *
 * @generated from protobuf message policy.DeleteO
 */
export interface DeleteO {
  /**
   * @generated from protobuf field: policy.DeleteO_Filter filter = 100;
   */
  filter?: DeleteO_Filter;
  /**
   * @generated from protobuf field: repeated policy.DeleteO_Object object = 200;
   */
  object: DeleteO_Object[];
}
/**
 * @generated from protobuf message policy.DeleteO_Filter
 */
export interface DeleteO_Filter {}
/**
 * @generated from protobuf message policy.DeleteO_Object
 */
export interface DeleteO_Object {
  /**
   * @generated from protobuf field: policy.DeleteO_Object_Intern intern = 100;
   */
  intern?: DeleteO_Object_Intern;
  /**
   * @generated from protobuf field: policy.DeleteO_Object_Public public = 200;
   */
  public?: DeleteO_Object_Public;
}
/**
 * @generated from protobuf message policy.DeleteO_Object_Intern
 */
export interface DeleteO_Object_Intern {}
/**
 * @generated from protobuf message policy.DeleteO_Object_Public
 */
