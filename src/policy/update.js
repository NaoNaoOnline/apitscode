...
class UpdateI_Object_Intern$Type extends MessageType {
    constructor() {
        super("policy.UpdateI_Object_Intern", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class UpdateI_Object_Public$Type extends MessageType {
    constructor() {
        super("policy.UpdateI_Object_Public", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class UpdateI_Object_Update$Type extends MessageType {
    constructor() {
        super("policy.UpdateI_Object_Update", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class UpdateO_Object$Type extends MessageType {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* policy.UpdateO_Object_Intern intern */ 100:
    ...
    internalBinaryWrite(message, writer, options) {
        /* policy.UpdateO_Object_Intern intern = 100; */
        if (message.intern)
...
class UpdateO_Object_Intern$Type extends MessageType {
    constructor() {
        super("policy.UpdateO_Object_Intern", [
...
class UpdateO_Object_Public$Type extends MessageType {
    constructor() {
        super("policy.UpdateO_Object_Public", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
