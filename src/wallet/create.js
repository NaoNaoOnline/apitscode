...
class CreateO_Object_Intern$Type extends MessageType {
    constructor() {
        super("wallet.CreateO_Object_Intern", [
            ...
            { no: 200, name: "wllt", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value) {
        const message = { crtd: "", wllt: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* string wllt = 200; */
        if (message.wllt !== "")
            writer.tag(200, WireType.LengthDelimited).string(message.wllt);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
