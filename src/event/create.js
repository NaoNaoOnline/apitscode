...
class CreateI_Object_Intern$Type extends MessageType {
    constructor() {
        super("event.CreateI_Object_Intern", []);
    }
    create(value) {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
