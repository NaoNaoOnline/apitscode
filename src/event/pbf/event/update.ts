...
export interface UpdateI {
  /**
   * @generated from protobuf field: event.UpdateI_Filter filter = 1;
   */
  filter?: UpdateI_Filter;
  /**
   * @generated from protobuf field: repeated event.UpdateI_Object object = 2;
   */
...
export interface UpdateI_Object {
  ...
  /**
   * @generated from protobuf field: repeated event.UpdateI_Object_Update update = 2;
   */
...
export interface UpdateO {
  /**
   * @generated from protobuf field: event.UpdateO_Filter filter = 1;
   */
  filter?: UpdateO_Filter;
  /**
   * @generated from protobuf field: repeated event.UpdateO_Object object = 2;
   */
...
export interface UpdateO_Object {
  ...
  /**
   * @generated from protobuf field: event.UpdateO_Object_Public public = 2;
   */
  ...
  private binaryReadMap1(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field event.UpdateI_Object.intern",
          );
      }
    }
    map[key ?? ""] = val ?? "";
  ...
  private binaryReadMap1(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field event.UpdateO_Object.intern",
          );
      }
    }
    map[key ?? ""] = val ?? "";
