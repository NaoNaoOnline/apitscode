...
export interface CreateI {
  /**
   * @generated from protobuf field: event.CreateI_Filter filter = 100;
   */
  filter?: CreateI_Filter;
  /**
   * @generated from protobuf field: repeated event.CreateI_Object object = 200;
   */
...
export interface CreateI_Object {
  /**
   * @generated from protobuf field: event.CreateI_Object_Intern intern = 100;
   */
  intern?: CreateI_Object_Intern;
  /**
   * @generated from protobuf field: event.CreateI_Object_Public public = 200;
   */
  public?: CreateI_Object_Public;
}
/**
 * @generated from protobuf message event.CreateI_Object_Intern
 */
...
export interface CreateO {
  /**
   * @generated from protobuf field: event.CreateO_Filter filter = 100;
   */
  filter?: CreateO_Filter;
  /**
   * @generated from protobuf field: repeated event.CreateO_Object object = 200;
   */
...
export interface CreateO_Object {
  /**
   * @generated from protobuf field: event.CreateO_Object_Intern intern = 100;
   */
  intern?: CreateO_Object_Intern;
  /**
   * @generated from protobuf field: event.CreateO_Object_Public public = 200;
   */
  public?: CreateO_Object_Public;
}
/**
 * @generated from protobuf message event.CreateO_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message event.CreateI_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message event.CreateO_Object_Intern
 */
