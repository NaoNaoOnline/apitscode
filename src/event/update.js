...
class UpdateI_Object$Type extends MessageType {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* map<string, string> intern */ 1:
                    ...
                    break;
                case /* repeated event.UpdateI_Object_Update update */ 2:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field event.UpdateI_Object.intern");
            }
        }
        map[key ?? ""] = val ?? "";
    }
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated event.UpdateI_Object_Update update = 2; */
...
class UpdateI_Object_Update$Type extends MessageType {
    constructor() {
        super("event.UpdateI_Object_Update", [
...
class UpdateO_Object$Type extends MessageType {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* map<string, string> intern */ 1:
                    this.binaryReadMap1(message.intern, reader, options);
                    break;
                case /* event.UpdateO_Object_Public public */ 2:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field event.UpdateO_Object.intern");
            }
        }
        map[key ?? ""] = val ?? "";
    }
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.intern))
            writer.tag(1, WireType.LengthDelimited).fork().tag(1, WireType.LengthDelimited).string(k).tag(2, WireType.LengthDelimited).string(message.intern[k]).join();
        /* event.UpdateO_Object_Public public = 2; */
        if (message.public)
...
class UpdateO_Object_Public$Type extends MessageType {
    constructor() {
        super("event.UpdateO_Object_Public", []);
    }
    create(value) {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
