...
export interface UpdateI_Object {
  ...
  /**
   * @generated from protobuf field: repeated event.UpdateI_Object_Public public = 200;
   */
  public: UpdateI_Object_Public[];
  /**
   * @generated from protobuf field: repeated event.UpdateI_Object_Update update = 300;
   */
