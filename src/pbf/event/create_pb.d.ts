...
export class CreateI_Object_Public extends jspb.Message {
  getDura(): string;
  setDura(value: string): CreateI_Object_Public;

  getHost(): string;
  setHost(value: string): CreateI_Object_Public;

  getLabl(): string;
  setLabl(value: string): CreateI_Object_Public;

  getLink(): string;
  setLink(value: string): CreateI_Object_Public;

  getTime(): string;
  setTime(value: string): CreateI_Object_Public;
