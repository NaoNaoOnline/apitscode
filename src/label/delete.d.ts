...
export interface DeleteI {
  /**
   * @generated from protobuf field: label.DeleteI_Filter filter = 100;
   */
  filter?: DeleteI_Filter;
  /**
   * @generated from protobuf field: repeated label.DeleteI_Object object = 200;
   */
...
export interface DeleteI_Object {
  /**
   * @generated from protobuf field: label.DeleteI_Object_Intern intern = 100;
   */
  intern?: DeleteI_Object_Intern;
  /**
   * @generated from protobuf field: label.DeleteI_Object_Public public = 200;
   */
  public?: DeleteI_Object_Public;
}
/**
 * @generated from protobuf message label.DeleteI_Object_Intern
 */
...
export interface DeleteO {
  /**
   * @generated from protobuf field: label.DeleteO_Filter filter = 100;
   */
  filter?: DeleteO_Filter;
  /**
   * @generated from protobuf field: repeated label.DeleteO_Object object = 200;
   */
...
export interface DeleteO_Object {
  /**
   * @generated from protobuf field: label.DeleteO_Object_Intern intern = 100;
   */
  intern?: DeleteO_Object_Intern;
  /**
   * @generated from protobuf field: label.DeleteO_Object_Public public = 200;
   */
  public?: DeleteO_Object_Public;
}
/**
 * @generated from protobuf message label.DeleteO_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message label.DeleteI_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message label.DeleteO_Object_Intern
 */
