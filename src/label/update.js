...
class UpdateI_Object_Intern$Type extends MessageType {
    constructor() {
        super("label.UpdateI_Object_Intern", [
...
class UpdateI_Object_Symbol$Type extends MessageType {
    constructor() {
        super("label.UpdateI_Object_Symbol", []);
    }
    create(value) {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
...
/**
 * @generated MessageType for protobuf message label.UpdateI_Object_Symbol
 */
...
class UpdateO_Object_Intern$Type extends MessageType {
    constructor() {
        super("label.UpdateO_Object_Intern", [
...
/**
 * @generated MessageType for protobuf message label.UpdateO_Object_Intern
 */
