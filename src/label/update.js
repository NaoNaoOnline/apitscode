...
class UpdateI_Object$Type extends MessageType {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* label.UpdateI_Object_Intern intern */ 100:
                    ...
                    break;
                case /* repeated label.UpdateI_Object_Public public */ 200:
                    message.public.push(UpdateI_Object_Public.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated label.UpdateI_Object_Update update */ 300:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated label.UpdateI_Object_Public public = 200; */
        ...
        /* repeated label.UpdateI_Object_Update update = 300; */
