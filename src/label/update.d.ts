...
export interface UpdateI {
  /**
   * @generated from protobuf field: label.UpdateI_Filter filter = 100;
   */
  filter?: UpdateI_Filter;
  /**
   * @generated from protobuf field: repeated label.UpdateI_Object object = 200;
   */
...
export interface UpdateI_Object {
  /**
   * @generated from protobuf field: label.UpdateI_Object_Intern intern = 100;
   */
  intern?: UpdateI_Object_Intern;
  /**
   * @generated from protobuf field: label.UpdateI_Object_Public public = 200;
   */
  public?: UpdateI_Object_Public;
  /**
   * @generated from protobuf field: label.UpdateI_Object_Symbol symbol = 300;
   */
  symbol?: UpdateI_Object_Symbol;
  /**
   * @generated from protobuf field: repeated label.UpdateI_Object_Update update = 400;
   */
...
/**
 * @generated from protobuf message label.UpdateI_Object_Symbol
 */
...
export interface UpdateO {
  /**
   * @generated from protobuf field: label.UpdateO_Filter filter = 100;
   */
  filter?: UpdateO_Filter;
  /**
   * @generated from protobuf field: repeated label.UpdateO_Object object = 200;
   */
...
export interface UpdateO_Object {
  /**
   * @generated from protobuf field: label.UpdateO_Object_Intern intern = 100;
   */
  intern?: UpdateO_Object_Intern;
  /**
   * @generated from protobuf field: label.UpdateO_Object_Public public = 200;
   */
  public?: UpdateO_Object_Public;
}
/**
 * @generated from protobuf message label.UpdateO_Object_Intern
 */
