...
class SearchO_Filter$Type extends MessageType {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* vote.SearchO_Filter_Paging paging */ 100:
    ...
    internalBinaryWrite(message, writer, options) {
        /* vote.SearchO_Filter_Paging paging = 100; */
        if (message.paging)
...
class SearchO_Filter_Paging$Type extends MessageType {
    constructor() {
        super("vote.SearchO_Filter_Paging", [
...
/**
 * @generated MessageType for protobuf message vote.SearchO_Filter_Paging
 */
